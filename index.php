...
<head>
    ...
    <!-- Custom Style Sheet -->
    <link href="public/styles/monkstyles.css" rel="stylesheet" />
    ...
    <header class="container" role="banner">
        ...
        <div class="row justify-content-end">
            ...
            <div class="col-md-4 d-none d-md-block d-print-none">
                <img src="public/img/medievalmonks.jpg" class="img-fluid" alt="Medieval Monks" />
            </div>
        </div><!-- END ROW-->
    </header><!--END HEADER-->
    ...
    <footer class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-3 offset-1 d-none d-md-block d-print-none p-md-3">
                <img src="public/img/monksdifferentorders1.jpg" class="img-fluid" alt="Orders of monks" id="difformonks" />
            </div>
